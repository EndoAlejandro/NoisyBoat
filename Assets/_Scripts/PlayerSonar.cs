...
public class PlayerSonar : ImmediateModeShapeDrawer
{
    ...
    [FormerlySerializedAs("_cooldown")] [SerializeField]
    private float _sonarCooldown = 2f;
    ...
    [FormerlySerializedAs("_innerRadius")] [SerializeField]
    ...
    [FormerlySerializedAs("_increaseTime")] [SerializeField]
    private float _increaseDuration = .2f;
